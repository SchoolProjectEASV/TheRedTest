Feature: FindAvailableWarehouse - Boundary Tests
  ...
  Scenario: Invalid date range (start after end)
    ...
    And I have "1" warehouse with total volume "1.0"
    And the warehouse usage is empty on all days
    When I call FindAvailableWarehouse from "2025-01-10" to "2025-01-09" with dimensions "1.0,1.0,1.0"
  ...
  Scenario: Zero or negative dimension
    ...
    When I call FindAvailableWarehouse from "2025-01-10" to "2025-01-11" with dimensions "0.0,1.0,1.0"
  ...
  Scenario: Required volume == Warehouse capacity
    ...
    And I have "1" warehouse with total volume "10.0"
    And the warehouse usage is empty on all days
    When I call FindAvailableWarehouse from "2025-01-10" to "2025-01-11" with dimensions "2.15,2.15,2.15"
    Then I should receive warehouse ID "1"
  ...
  Scenario: Empty warehouse list
    ...
    When I call FindAvailableWarehouse from "2025-01-10" to "2025-01-11" with dimensions "1.0,1.0,1.0"
